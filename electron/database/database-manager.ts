...
import { NormalizedCifRepository } from "./repositories/NormalizedCifRepository";
...
class DatabaseManager {
  ...
  // New normalized CIF repository and service
  public cifNormalized: NormalizedCifRepository;
  public cifService: CifService;
  ...
  constructor() {
    ...
    // Initialize new CIF repository and service (will be fully initialized after connection)
    this.cifNormalized = new NormalizedCifRepository(null as any);
    this.cifService = new CifService(this.cifNormalized);
  }
  ...
  public connect(): void {
    try {
      ...
      // Initialize new CIF repository and service with the connected database
      this.cifNormalized = new NormalizedCifRepository(this.db);
      this.cifService = new CifService(this.cifNormalized);
